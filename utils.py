...
def reload_model(model, to_reload, attributes):
    ...
    for k in model.state_dict().keys():
        #if 'domain_embed' in k or 'task_embed' in k or 'lang_embed' in k:
        #    continue
        #if 'domain_layer' in k or 'task_layer' in k or 'lang_layer' in k:
        #    continue
        if 'loss_fn' in k:
            continue
        #if 'domain_fc' in k or 'task_fc' in k or 'lang_fc' in k:
        #    continue
        #if 'domain_embed_fc' in k or 'task_embed_fc' in k or 'lang_embed_fc' in k:
        #    continue
        #if 'domain_proj' in k or 'task_proj' in k or 'lang_embed_fc' in k:
        #    continue
        #if 'embed' in k or 'proj' in k:
        #    continue
        print(k)
