...
def update_lambdas(params, n_total_iter):
    ...
    """
    if params.lambda_xe_mono_in_config is not None:
        params.lambda_xe_mono_in = update_lambda_value(params.lambda_xe_mono_in_config, n_total_iter)
    if params.lambda_xe_mono_out_config is not None:
        params.lambda_xe_mono_out = update_lambda_value(params.lambda_xe_mono_out_config, n_total_iter)
    if params.lambda_xe_para_in_config is not None:
        params.lambda_xe_para_in = update_lambda_value(params.lambda_xe_para_in_config, n_total_iter)
    if params.lambda_xe_para_out_config is not None:
        params.lambda_xe_para_out = update_lambda_value(params.lambda_xe_para_out_config, n_total_iter)
