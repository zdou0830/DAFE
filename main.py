...
def get_parser():
    ...
    parser.add_argument("--mono_in_dataset", type=str, default="",
                        help="In-domain monolingual dataset (lang1:train1,valid1,test1;lang2:train2,valid2,test2)")
    parser.add_argument("--mono_out_dataset", type=str, default="",
                        help="Out-of-domain monolingual dataset (lang1:train1,valid1,test1;lang2:train2,valid2,test2)")
    parser.add_argument("--para_in_dataset", type=str, default="",
                        help="In-domain parallel dataset (lang1-lang2:train12,valid12,test12;lang1-lang3:train13,valid13,test13)")
    parser.add_argument("--para_out_dataset", type=str, default="",
                        help="Out-of-domain parallel dataset (lang1-lang2:train12,valid12,test12;lang1-lang3:train13,valid13,test13)")
    ...
    parser.add_argument("--lambda_xe_mono_in", type=str, default="0",
                        help="Cross-entropy reconstruction coefficient (in-domain masked lm)")
    parser.add_argument("--lambda_xe_mono_out", type=str, default="0",
                        help="Cross-entropy reconstruction coefficient (out-of-domain masked lm)")
    parser.add_argument("--lambda_xe_para_in", type=str, default="0",
                        help="Cross-entropy reconstruction coefficient (in-domain parallel data)")
    parser.add_argument("--lambda_xe_para_out", type=str, default="0",
                        help="Cross-entropy reconstruction coefficient (out-of-domain parallel data)")
...
def main(params):
    ...
    for _ in range(trainer.epoch, params.max_epoch):
        ...
        while trainer.n_sentences < params.epoch_size:
            ...
            # in-domain MT training (parallel data)
            if params.lambda_xe_para_in > 0:
                for lang1, lang2 in params.para_directions:
                    trainer.enc_dec_step(lang1, lang2, params.lambda_xe_para_in, in_domain=True)

            # out-of-domain MT training (parallel data)
            if params.lambda_xe_para_out > 0:
                for lang1, lang2 in params.para_directions:
                    trainer.enc_dec_step(lang1, lang2, params.lambda_xe_para_out, in_domain=False)
            ...
            if params.lambda_xe_mono_in > 0:
                for lang in params.mono_directions:
                    trainer.enc_dec_step(lang, lang, params.lambda_xe_mono_in, in_domain=True)

            # autoencoder training (monolingual data)
            if params.lambda_xe_mono_out > 0:
                for lang in params.mono_directions:
                    trainer.enc_dec_step(lang, lang, params.lambda_xe_mono_out, in_domain=False)
