        ...
        for (lang1, lang2), v in self.data['para'].items():
            ...
            for data_type in ['valid', 'test']:
                ...
                for (sent1, len1), (sent2, len2) in self.get_iterator(data_type, lang1, lang2):
                    lang1_txt.extend(convert_to_text(sent1, len1, self.dico[lang1], lang1_id, params, ref=True))
                    lang2_txt.extend(convert_to_text(sent2, len2, self.dico[lang2], lang2_id, params, ref=True))
...
def convert_to_text(batch, lengths, dico, lang_id, params, ref=False):
    """
