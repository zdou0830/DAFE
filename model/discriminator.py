...
class Discriminator(nn.Module):
    ...
    def __init__(self, params, output_dim = -1):
        """
        ...
        self.output_dim = params.n_langs if output_dim == -1 else output_dim
        ...
        for i in range(self.dis_layers + 1):
            ...
            output_dim = self.dis_hidden_dim if i < self.dis_layers else self.output_dim
